...
sudo --preserve-env=DISCORD_BOT_TOKEN,DISCORD_TARGET,OPENAI_API_KEY,ANTHROPIC_API_KEY,FRONTEND_ENABLED -u "$OPENCLAW_USER" -H bash -lc "cd '$REPO_DIR' && bash scripts/bootstrap-openclaw.sh"
