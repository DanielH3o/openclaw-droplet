...
setup_placeholder_frontend() {
  ...
  say "Setting up placeholder frontend (nginx)"
  sudo apt-get update -y
...
<head>
  ...
  <style>
    ...
    h1 { margin-top: 0; }
    code { background: #1f2a50; padding: 2px 6px; border-radius: 6px; }
    .muted { color: #9fb0e8; }
  </style>
</head>
<body>
  <div class="wrap">
    <div class="card">
      ...
      <p class="muted">Placeholder frontend is live on this droplet.</p>
      <p>Replace this page with your app when you’re ready.</p>
      <p><strong>OpenClaw interface:</strong> Discord channel <code>${DISCORD_CHANNEL_ID}</code></p>
      <p class="muted">Generated by openclaw-droplet bootstrap.</p>
    </div>
  </div>
</body>
</html>
